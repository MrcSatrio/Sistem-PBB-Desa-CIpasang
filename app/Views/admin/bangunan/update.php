            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">UPDATE BANGUNAN</h1>
                        <div class="card mb-4">
                            <div class="card-body">
                            <form action="<?= base_url('/admin/action_update_bangunan') ?>" method="post">
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" name="id_dusun" aria-label="Default select example">
                                    <?php foreach ($dusun as $ds) : ?>
                                        <?php $selected = ($ds['id_dusun'] == $bangunan['id_dusun']) ? 'selected' : ''; ?>
                                        <option <?= $selected; ?> value="<?= $ds['id_dusun']; ?>"><?= $ds['nama_dusun']; ?></option>
                                    <?php endforeach ?>
                                </select>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="alamat" name="alamat" rows="3" required><?php echo $bangunan['alamat'] ?></textarea>
                            </div>
                            <input type="hidden" name="id_bangunan" value="<?php echo $bangunan['id_bangunan'] ?>">
