            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">DATA BANGUNAN</h1>
                        <div class="card mb-4">
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <?php $i = 1;
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?= base_url('/admin/update_bangunan/' . $br['id_bangunan']) ?>" class="btn btn-sm btn-primary btn-circle profile">
                                                    <i class="far fa-user"></i>
                                                </a>
                                                <a href="<?= base_url('/admin/delete_bangunan/' . $br['id_bangunan']) ?>" class="btn btn-sm btn-danger btn-circle delete">
