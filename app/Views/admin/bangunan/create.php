            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">TAMBAH BANGUNAN</h1>
                        <div class="card mb-4">
                            <div class="card-body">
                            <form action="<?= base_url('/admin/create_bangunan') ?>" method="post">
                            <label for="exampleDataList" class="form-label">Nama Lengkap</label>
                                <input class="form-control" list="datalistOptions" id="exampleDataList" name="nama" placeholder="Isi Sesuai Nama KTP" required>
                            ...
                            <?php $i = 1;
                                        foreach ($dusun as $ds) : ?>
                            <option value="<?= $ds['id_dusun']; ?>"><?= $ds['nama_dusun']; ?></option>
                            <?php endforeach ?>
                            </select>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="alamat" name="alamat" rows="3" placeholder="Isi Sesuai Alamat Bangunan" required></textarea>
                            </div>
